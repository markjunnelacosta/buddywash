...
function SupplyInOut (){
        ...
        return(
            <div className="supplyInOut-container">
                ...
                <Button style={{backgroundColor:"white", color:"black", width:"200px", height:"50px",fontWeight:"bold", alignSelf:"flex-end", margin:"30px", borderRadius:"10px"}} variant="contained" >
                  Manage Supply
                </Button>
                ...
                <div className="table-container">{AddSupplyInOut()}</div>
                </div>
